/* Generated by erlresolvelinks at {{2014,4,7},{19,14,50}} UTC */
function erlhref(ups, app, rest) {
    ...
    case "doc/tutorial":
        ...
        break;
    case "erts":
        location.href=ups + "/erts-6.0/doc/html/" + rest;
        break;
    case "asn1":
        location.href=ups + "lib/asn1-3.0/doc/html/" + rest;
        break;
    case "common_test":
        location.href=ups + "lib/common_test-1.8/doc/html/" + rest;
        break;
    case "compiler":
        location.href=ups + "lib/compiler-5.0/doc/html/" + rest;
        break;
    case "cosEvent":
    ...
    case "cosTransactions":
        ...
        break;
    case "crypto":
        location.href=ups + "lib/crypto-3.3/doc/html/" + rest;
        break;
    case "debugger":
        location.href=ups + "lib/debugger-4.0/doc/html/" + rest;
        break;
    case "dialyzer":
        location.href=ups + "lib/dialyzer-2.7/doc/html/" + rest;
        break;
    case "diameter":
        location.href=ups + "lib/diameter-1.6/doc/html/" + rest;
        break;
    case "edoc":
    ...
    case "erl_docgen":
        ...
        break;
    case "erl_interface":
        location.href=ups + "lib/erl_interface-3.7.16/doc/html/" + rest;
        break;
    case "et":
    ...
    case "gs":
        ...
        break;
    case "hipe":
        location.href=ups + "lib/hipe-3.10.3/doc/html/" + rest;
        break;
    case "ic":
        location.href=ups + "lib/ic-4.3.5/doc/html/" + rest;
        break;
    case "inets":
        location.href=ups + "lib/inets-5.10/doc/html/" + rest;
        break;
    case "jinterface":
        location.href=ups + "lib/jinterface-1.5.9/doc/html/" + rest;
        break;
    case "kernel":
        location.href=ups + "lib/kernel-3.0/doc/html/" + rest;
        break;
    case "megaco":
        location.href=ups + "lib/megaco-3.17.1/doc/html/" + rest;
        break;
    case "mnesia":
        location.href=ups + "lib/mnesia-4.12/doc/html/" + rest;
        break;
    case "observer":
        location.href=ups + "lib/observer-2.0/doc/html/" + rest;
        break;
    case "odbc":
    ...
    case "public_key":
        ...
        break;
    case "reltool":
        location.href=ups + "lib/reltool-0.6.5/doc/html/" + rest;
        break;
    case "runtime_tools":
    ...
    case "snmp":
        ...
        break;
    case "ssh":
        location.href=ups + "lib/ssh-3.0.1/doc/html/" + rest;
        break;
    case "ssl":
        location.href=ups + "lib/ssl-5.3.4/doc/html/" + rest;
        break;
    case "stdlib":
        location.href=ups + "lib/stdlib-2.0/doc/html/" + rest;
        break;
    case "syntax_tools":
        location.href=ups + "lib/syntax_tools-1.6.14/doc/html/" + rest;
        break;
    case "test_server":
        location.href=ups + "lib/test_server-3.7/doc/html/" + rest;
        break;
    case "tools":
        location.href=ups + "lib/tools-2.6.14/doc/html/" + rest;
        break;
    case "typer":
        location.href=ups + "lib/typer-0.9.6/doc/html/" + rest;
        break;
    case "webtool":
        location.href=ups + "lib/webtool-0.8.10/doc/html/" + rest;
        break;
    case "wx":
        location.href=ups + "lib/wx-1.2/doc/html/" + rest;
        break;
    case "xmerl":
