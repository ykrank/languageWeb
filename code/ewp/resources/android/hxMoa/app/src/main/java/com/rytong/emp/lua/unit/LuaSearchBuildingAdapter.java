 ...
 * 
 */
public class LuaSearchBuildingAdapter extends BaseAdapter {
	private List<SearchTreeChild> mList;
	private Context mContext;
	public static List<String> delList;//删除显示值
	public static Map<Integer, Boolean> isSelected;
	public static Map<Integer , String> selectedValue;
	public LuaSearchBuildingAdapter(Context context) {
		this.mContext = context;
		delList = new ArrayList<String>();
	}

	public void setData(List<SearchTreeChild> list) {
		this.mList = list;
	...
	@Override
	public SearchTreeChild getItem(int position) {
		// TODO Auto-generated method stub
